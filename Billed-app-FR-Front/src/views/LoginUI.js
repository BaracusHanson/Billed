            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input type="current-password" id="inputPassword"  data-testid="employee-password-input" class="form-control" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <input type="current-password"id="inputPasswordAdmin" data-testid="admin-password-input" class="form-control" placeholder="******" required>
