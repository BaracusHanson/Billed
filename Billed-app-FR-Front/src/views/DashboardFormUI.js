    ...
    <div class="container dashboard-form" data-testid="dashboard-form">
      <div class="row">
        <div class="col-sm" id="dashboard-form-col1">
          <label for="input-field" class="bold-label">Type de dépense</label>
          <div class='input-field'> ${bill.type} </div>
          <label for="input-field" class="bold-label">Nom de la dépense</label>
          <div class='input-field'> ${bill.name} </div>
          <label for="input-field" class="bold-label">Date</label>
        ...
        <div class="col-sm" id="dashboard-form-col2">
          <label for="textarea-field" class="bold-label">Commentaire</label>
      ...
      <div class="row">
        <div class="col-sm">
          <label for="input-field" class="bold-label">Montant TTC </label>
          <div class='input-field input-flex'>
      ...
      <div class="row">
        <div class="col-sm">
          <label for="input-field" class="bold-label">Justificatif</label>
      ...
      <div class="row">
       ...
       `
           : `
        <div class="col-sm">
          <label for="input-field" class="bold-label">Votre commentaire</label>
